...
static const struct msm_pingroup nord_groups[] = {
	...
	[70] = PINGROUP(70, aud_intfc1_data1, aud_intfc9_clk, phase_flag21, _, qdss_gpio3, _, _, _, _, _, _),
	[71] = PINGROUP(71, aud_intfc1_data2, aud_intfc9_ws, phase_flag22, _, qdss_gpio4, _, _, _, _, _, _),
	[72] = PINGROUP(72, aud_intfc1_data3, aud_intfc9_data0, phase_flag23, _, qdss_gpio5, _, _, _, _, _, _),
	[73] = PINGROUP(73, aud_intfc1_data4, aud_intfc8_clk, phase_flag24, _, qdss_gpio6, _, _, _, _, _, _),
	[74] = PINGROUP(74, aud_intfc1_data5, aud_intfc8_ws, phase_flag25, _, qdss_gpio7, _, _, _, _, _, _),
	[75] = PINGROUP(75, aud_intfc1_data6, aud_intfc8_data0, phase_flag26, _, qdss_gpio, _, _, _, _, _, _),
	[76] = PINGROUP(76, aud_intfc1_data7, aud_intfc8_data1, phase_flag27, _, qdss_gpio, _, _, _, _, _, _),
	...
	[81] = PINGROUP(81, aud_intfc2_data2, aud_intfc10_data0, phase_flag2, _, _, qdss_gpio12, _, _, _, _, _),
	[82] = PINGROUP(82, aud_intfc2_data3, aud_intfc10_data1, phase_flag1, _, qdss_gpio13, _, _, _, _, _, _),
	[83] = PINGROUP(83, aud_intfc3_clk, dp_rx0, aoss_cti, phase_flag28, _, qdss_gpio14, _, _, _, _, _),
	[84] = PINGROUP(84, aud_intfc3_ws, dp_rx0, aoss_cti, phase_flag29, _, qdss_gpio15, _, _, _, _, _),
	[85] = PINGROUP(85, aud_intfc3_data0, dp_rx0, aoss_cti, phase_flag30, _, qdss_gpio0, _, _, _, _, _),
	[86] = PINGROUP(86, aud_intfc3_data1, aud_mclk0_mirb, dp_rx0, aoss_cti, phase_flag31, _, qdss_gpio1, _, _, _, _),
	...
	[89] = PINGROUP(89, aud_intfc4_data0, dp_rx0, phase_flag9, _, qdss_gpio4, _, _, _, _, _, _),
	[90] = PINGROUP(90, aud_intfc4_data1, aud_mclk1_mirb, phase_flag10, _, qdss_gpio5, _, _, _, _, _, _),
	...
	[93] = PINGROUP(93, aud_intfc5_data0, dp_rx1, phase_flag13, _, qdss_gpio, _, _, _, _, _, _),
	[94] = PINGROUP(94, aud_intfc5_data1, aud_mclk2_mirb, phase_flag14, tmess_prng0, _, qdss_gpio8, _, _, _, _, _),
	[95] = PINGROUP(95, aud_intfc6_clk, dp_rx1, phase_flag15, tmess_prng1, _, qdss_gpio9, _, _, _, _, _),
	...
	[98] = PINGROUP(98, aud_intfc6_data1, dp_rx1, phase_flag0, _, qdss_gpio12, _, _, _, _, _, _),
	[99] = PINGROUP(99, aud_mclk0_mira, qdss_gpio13, dp_rx00, ddr_pxi0, _, _, _, _, _, _, _),
	[100] = PINGROUP(100, aud_mclk1_mira, aud_refclk0, pll_clk_aux, qdss_gpio14, dp_rx01, ddr_pxi0, _, _, _, _, _),
	[101] = PINGROUP(101, aud_mclk2_mira, aud_refclk1, phase_flag17, _, qdss_gpio15, _, _, _, _, _, _),
	...
	[109] = PINGROUP(109, qup0_se0_l2, qup0_se1_l2, qup0_se5_l2, mdp_vsync_e, smb_alert_n, _, ddr_pxi1, _, _, _, _),
	[110] = PINGROUP(110, qup0_se0_l3, qup0_se1_l3, qup0_se5_l3, qdss_cti, mdp_vsync_p, smb_alert, _, ddr_pxi1, _, _, _),
	...
	[113] = PINGROUP(113, qup0_se2_l0, qup0_se3_l2, ccu_i2c_sda5, mdp0_vsync0_out, dbg_out, ddr_pxi2, _, _, _, _, _),
	[114] = PINGROUP(114, qup0_se2_l1, qup0_se3_l3, ccu_i2c_scl5, mdp0_vsync1_out, _, ddr_pxi2, _, _, _, _, _),
	[115] = PINGROUP(115, qup0_se3_l0, qup0_se2_l2, ccu_i2c_sda6, mdp0_vsync2_out, _, ddr_pxi3, _, _, _, _, _),
	[116] = PINGROUP(116, qup0_se3_l1, qup0_se2_l3, ccu_i2c_scl6, mdp0_vsync3_out, _, ddr_pxi3, _, _, _, _, _),
	...
	[121] = PINGROUP(121, qup0_se5_l0, lbist_pass, mdp0_vsync4_out, _, dp_rx10, ddr_pxi7, _, _, _, _, _),
	[122] = PINGROUP(122, qup0_se5_l1, mbist_pass, mdp0_vsync5_out, _, dp_rx11, ddr_pxi7, _, _, _, _, _),
	[123] = PINGROUP(123, qup1_se0_l0, qup1_se1_l2, mdp1_vsync0_out, jitter_bist, _, _, _, _, _, _, _),
	[124] = PINGROUP(124, qup1_se0_l1, qup1_se1_l3, mdp1_vsync1_out, _, _, _, _, _, _, _, _),
	[125] = PINGROUP(125, qup1_se1_l0, qup1_se0_l2, ccu_i2c_sda7, mdp1_vsync2_out, _, _, _, _, _, _, _),
	[126] = PINGROUP(126, qup1_se1_l1, qup1_se0_l3, ccu_i2c_scl7, mdp1_vsync3_out, _, atest_usb20, ddr_pxi8, _, _, _, _),
	[127] = PINGROUP(127, qup1_se2_l2, qup1_se2_l0, _, atest_usb21, ddr_pxi8, _, _, _, _, _, _),
	[128] = PINGROUP(128, qup1_se2_l3, qup1_se2_l1, _, atest_usb20, ddr_pxi9, _, _, _, _, _, _),
	[129] = PINGROUP(129, qup1_se3_l2, qup1_se3_l0, ccu_i2c_sda8, mdp1_vsync4_out, _, atest_usb21, ddr_pxi9, _, _, _, _),
	[130] = PINGROUP(130, qup1_se3_l3, qup1_se3_l1, ccu_i2c_scl8, mdp1_vsync5_out, _, atest_usb20, ddr_pxi10, _, _, _, _),
	[131] = PINGROUP(131, qup1_se4_l0, qup1_se6_l2, ccu_i2c_sda9, mdp1_vsync6_out, _, atest_usb21, ddr_pxi10, _, _, _, _),
	[132] = PINGROUP(132, qup1_se4_l1, qup1_se6_l3, ccu_i2c_scl9, mdp1_vsync7_out, _, vsense_trigger_mirnat, ddr_pxi11, _, _, _, _),
	[133] = PINGROUP(133, qup1_se5_l0, emac0_ptp, mdp1_vsync8_out, _, ddr_pxi11, _, _, _, _, _, _),
	[134] = PINGROUP(134, qup1_se5_l1, emac0_ptp, mdp1_vsync9_out, _, ddr_pxi12, _, _, _, _, _, _),
	[135] = PINGROUP(135, qup1_se5_l2, emac0_ptp, mdp1_vsync10_out, _, ddr_pxi12, _, _, _, _, _, _),
	...
	[138] = PINGROUP(138, qup1_se6_l1, qup1_se4_l3, dp_rx0, qdss_cti, jitter_bist, ddr_pxi14, _, _, _, _, _),
	[139] = PINGROUP(139, qup2_se0_l0, emac0_ptp, mdp0_vsync6_out, ddr_pxi14, _, _, _, _, _, _, _),
	...
	[142] = PINGROUP(142, qup2_se0_l3, emac0_ptp, qdss_cti, mdp0_vsync9_out, _, _, _, _, _, _, _),
	[143] = PINGROUP(143, qup2_se1_l2, qup2_se4_l2, ccu_timer10, mdp0_vsync10_out, _, _, _, _, _, _, _),
	[144] = PINGROUP(144, qup2_se1_l3, qup2_se4_l3, ccu_timer11, qdss_cti, mdp_vsync_s, _, _, _, _, _, _),
	...
	[165] = PINGROUP(165, usb1_phy_ps, dbg_out_clk, sailss_ospi, ddr_pxi5, _, _, _, _, _, _, _),
	...
	[176] = PINGROUP(176, ccu_async_in0, pll_bist_sync, atest_char_start, _, _, _, _, _, _, _, _),
